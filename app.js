...
cloudinary.config({
	cloud_name: "manosmasa",
	api_key: "594138653914433",
	api_secret: "GAFUGX851mmfxt_LlpbG74SZHJo"
});
...
productSchema.virtual("image.url").get(function(){
	if(this.imageUrl === "" || this.imageUrl === "manosAlaMasa.png"){
		return "default.jpg";
	}
